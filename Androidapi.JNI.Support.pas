...
type
  ...
  Japp_FragmentManager_OnBackStackChangedListener = interface;
  ...
  JNotificationCompat_BigTextStyle = interface; // ZuBy
  ...
  TJapp_Fragment = class(TJavaGenericImport<Japp_FragmentClass, Japp_Fragment>)
  end;
  ...
  TJapp_Fragment_SavedState = class(TJavaGenericImport<Japp_Fragment_SavedStateClass, Japp_Fragment_SavedState>)
  end;
  ...
  TJFragmentActivity = class(TJavaGenericImport<JFragmentActivityClass, JFragmentActivity>)
  end;
  ...
  TJapp_FragmentManager = class(TJavaGenericImport<Japp_FragmentManagerClass, Japp_FragmentManager>)
  end;
  ...
  TJapp_FragmentManager_BackStackEntry = class(TJavaGenericImport<Japp_FragmentManager_BackStackEntryClass,
    Japp_FragmentManager_BackStackEntry>)
  end;
  ...
  TJapp_FragmentManager_OnBackStackChangedListener = class
    (TJavaGenericImport<Japp_FragmentManager_OnBackStackChangedListenerClass,
    Japp_FragmentManager_OnBackStackChangedListener>)
  end;
  ...
  Japp_FragmentTransaction = interface(JObject)
    ...
    function add(containerViewId: Integer; fragment: Japp_Fragment; tag: JString): Japp_FragmentTransaction;
      cdecl; overload;
    ...
    function replace(containerViewId: Integer; fragment: Japp_Fragment; tag: JString): Japp_FragmentTransaction;
      cdecl; overload;
    ...
    function setCustomAnimations(enter: Integer; exit: Integer; popEnter: Integer; popExit: Integer)
      : Japp_FragmentTransaction; cdecl; overload;
  ...
  TJapp_FragmentTransaction = class(TJavaGenericImport<Japp_FragmentTransactionClass, Japp_FragmentTransaction>)
  end;
  ...
  Japp_LoaderManager = interface(JObject)
    ...
    function initLoader(id: Integer; args: JBundle; callback: Japp_LoaderManager_LoaderCallbacks)
      : Jcontent_Loader; cdecl;
    function restartLoader(id: Integer; args: JBundle; callback: Japp_LoaderManager_LoaderCallbacks)
      : Jcontent_Loader; cdecl;
  end;

  TJapp_LoaderManager = class(TJavaGenericImport<Japp_LoaderManagerClass, Japp_LoaderManager>)
  end;
  ...
  TJapp_LoaderManager_LoaderCallbacks = class(TJavaGenericImport<Japp_LoaderManager_LoaderCallbacksClass,
    Japp_LoaderManager_LoaderCallbacks>)
  end;
  ...
  TJNotificationCompat_Builder = class(TJavaGenericImport<JNotificationCompat_BuilderClass,
  ...
  TJNotificationCompat_Style = class(TJavaGenericImport<JNotificationCompat_StyleClass, JNotificationCompat_Style>)
  end;

  // ZuBy ***
  JNotificationCompat_BigTextStyleClass = interface(JNotificationCompat_StyleClass)
    ['{0E443407-40E9-4985-9F1D-6D0CF1C5F652}']
    function bigText(cs: JCharSequence): JNotificationCompat_BigTextStyle; cdecl;
    // (Ljava/lang/CharSequence;)Landroid/app/Notification$BigTextStyle; A: $1
    function init: JNotificationCompat_BigTextStyle; cdecl; overload; // ()V A: $1
    function init(builder: JNotificationCompat_Builder): JNotificationCompat_BigTextStyle; cdecl; overload;
    // (Landroid/app/Notification$Builder;)V A: $1
    function setBigContentTitle(title: JCharSequence): JNotificationCompat_BigTextStyle; cdecl;
    // (Ljava/lang/CharSequence;)Landroid/app/Notification$BigTextStyle; A: $1
    function setSummaryText(cs: JCharSequence): JNotificationCompat_BigTextStyle; cdecl;
    // (Ljava/lang/CharSequence;)Landroid/app/Notification$BigTextStyle; A: $1
  end;
  ...
  //
  TJNotificationCompat_BigTextStyle = class(TJavaGenericImport<JNotificationCompat_BigTextStyleClass,
    JNotificationCompat_BigTextStyle>)
  end;
  // *** ZuBy
  ...
  TJcontent_Loader = class(TJavaGenericImport<Jcontent_LoaderClass, Jcontent_Loader>)
  end;
  ...
  TJcontent_Loader_OnLoadCompleteListener = class(TJavaGenericImport<Jcontent_Loader_OnLoadCompleteListenerClass,
    Jcontent_Loader_OnLoadCompleteListener>)
  end;
  ...
  TJWakefulBroadcastReceiver = class(TJavaGenericImport<JWakefulBroadcastReceiverClass, JWakefulBroadcastReceiver>)
  end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Support.Japp_Fragment_SavedState',
    TypeInfo(Androidapi.JNI.Support.Japp_Fragment_SavedState));
  TRegTypes.RegisterType('Androidapi.JNI.Support.JFragmentActivity',
    TypeInfo(Androidapi.JNI.Support.JFragmentActivity));
  TRegTypes.RegisterType('Androidapi.JNI.Support.Japp_FragmentManager',
    TypeInfo(Androidapi.JNI.Support.Japp_FragmentManager));
  TRegTypes.RegisterType('Androidapi.JNI.Support.Japp_FragmentManager_BackStackEntry',
    TypeInfo(Androidapi.JNI.Support.Japp_FragmentManager_BackStackEntry));
  TRegTypes.RegisterType('Androidapi.JNI.Support.Japp_FragmentManager_OnBackStackChangedListener',
    TypeInfo(Androidapi.JNI.Support.Japp_FragmentManager_OnBackStackChangedListener));
  TRegTypes.RegisterType('Androidapi.JNI.Support.Japp_FragmentTransaction',
    TypeInfo(Androidapi.JNI.Support.Japp_FragmentTransaction));
  TRegTypes.RegisterType('Androidapi.JNI.Support.Japp_LoaderManager',
    TypeInfo(Androidapi.JNI.Support.Japp_LoaderManager));
  TRegTypes.RegisterType('Androidapi.JNI.Support.Japp_LoaderManager_LoaderCallbacks',
    TypeInfo(Androidapi.JNI.Support.Japp_LoaderManager_LoaderCallbacks));
  TRegTypes.RegisterType('Androidapi.JNI.Support.JNotificationCompat_Builder',
    TypeInfo(Androidapi.JNI.Support.JNotificationCompat_Builder));
  TRegTypes.RegisterType('Androidapi.JNI.Support.JNotificationCompat_Style',
    TypeInfo(Androidapi.JNI.Support.JNotificationCompat_Style));
  // ZuBy ***
  TRegTypes.RegisterType('Androidapi.JNI.Support.JNotificationCompat_BigTextStyle',
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Support.Jcontent_Loader_OnLoadCompleteListener',
    TypeInfo(Androidapi.JNI.Support.Jcontent_Loader_OnLoadCompleteListener));
  TRegTypes.RegisterType('Androidapi.JNI.Support.JWakefulBroadcastReceiver',
    TypeInfo(Androidapi.JNI.Support.JWakefulBroadcastReceiver));
end;
