...
uses
  FMX.Types, FMX.Controls, System.SysUtils, RegularExpressions
{$IFDEF ANDROID}
...
begin
  ...
  if TANdroidHelper.Context.checkSelfPermission
    ...
    TANdroidHelper.Activity.requestPermissions
      (CreateJavaStringArray(['android.permission.ACCESS_FINE_LOCATION']),
...
begin
  ...
  if TANdroidHelper.Context.checkSelfPermission
    (StringToJString('android.permission.INTERNET'))
    = TJPackageManager.JavaClass.PERMISSION_DENIED then
    TANdroidHelper.Activity.requestPermissions
      (CreateJavaStringArray(['android.permission.INTERNET']),
      PERMISSION_REQUEST_CODE);
end;
...
begin
  ...
  if TANdroidHelper.Context.checkSelfPermission
    (StringToJString('android.permission.READ_EXTERNAL_STORAGE'))
    = TJPackageManager.JavaClass.PERMISSION_DENIED then
    TANdroidHelper.Activity.requestPermissions
      (CreateJavaStringArray(['android.permission.READ_EXTERNAL_STORAGE']),
      PERMISSION_REQUEST_CODE);
  // android.permission.WRITE_EXTERNAL_STORAGE
  if TANdroidHelper.Context.checkSelfPermission
    (StringToJString('android.permission.WRITE_EXTERNAL_STORAGE'))
    = TJPackageManager.JavaClass.PERMISSION_DENIED then
    TANdroidHelper.Activity.requestPermissions
      (CreateJavaStringArray(['android.permission.WRITE_EXTERNAL_STORAGE']),
      PERMISSION_REQUEST_CODE);
end;
...
begin
  ...
  if TANdroidHelper.Context.checkSelfPermission
    (StringToJString('android.permission.READ_PHONE_STATE'))
    = TJPackageManager.JavaClass.PERMISSION_DENIED then
    TANdroidHelper.Activity.requestPermissions
      (CreateJavaStringArray(['android.permission.READ_PHONE_STATE']),
      PERMISSION_REQUEST_CODE);
end;
